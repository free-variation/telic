#!/bin/sh
# Disassemble every word defined in each bench/**.telic file.
#
# For each .telic under ./bench: extract its colon-definition names, load the
...
find "$root/bench" -name '*.telic' | sort | while IFS= read -r file; do
	echo "================================================================"
	echo "# $file"
	echo "================================================================"
