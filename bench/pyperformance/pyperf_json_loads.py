"""Standalone harness version of pyperformance's bm_json_loads.

DICT, TUPLE, mutate_dict, the fixed-seed random_source, DICT_GROUP, and
...
with sort_keys=True, which the telic side reproduces with
...
if __name__ == "__main__":
    ...
    print(f"bytes: {total_bytes(objs)}")
