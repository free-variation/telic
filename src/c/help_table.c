...
const HelpEntry help_entries[] = {
	...
	{ "++", "( -- )", "Increment the named local or global variable by 1 in place; only inside a colon definition; a global target is declared ^name in the head; errors on an unknown or non-variable name", "1", "none", "O(1)", 10 },
	...
	{ "--", "( -- )", "Decrement the named local or global variable by 1 in place; only inside a colon definition; a global target is declared ^name in the head; errors on an unknown or non-variable name", "1", "none", "O(1)", 10 },
	...
	{ ":]", "—", "Close a quotation ([: itself is under Defining)", NULL, NULL, NULL, 9 },
	...
	{ "f++", "( -- ) ⚠", "Unsafe float increment: raw .number mutation, no tag check, for a local known to hold a float; a global target is declared ^name in the head", "1", "none", "O(1)", 10 },
	{ "f-", "( a b -- a-b ) ⚠", "subtract", "2", "none", "O(1)", 1 },
	{ "f--", "( -- ) ⚠", "Unsafe float decrement: raw .number mutation, no tag check; a global target is declared ^name in the head", "1", "none", "O(1)", 10 },
	...
	{ "|", "—", "Close a body's locals head, and open it when no name precedes: | x y | and x y | both receive x and y (see Locals)", NULL, NULL, NULL, 9 },
