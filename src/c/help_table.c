...
const HelpEntry help_entries[] = {
	...
	{ "axes", "( -- )", "Plot-area border plus labeled x and y ticks, laid out at render time", NULL, NULL, NULL, 41 },
	...
	{ "panel", "( -- )", "axes' themed twin: a filled ground (:panel-fill) with gridlines as negative space and labeled ticks, no border; call before the data so it draws underneath", NULL, NULL, NULL, 41 },
...
const int help_entry_count = 620;
