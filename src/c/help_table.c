...
const HelpEntry help_entries[] = {
	...
	{ "frobenius-norm", "( m -- f )", "Euclidean (L2) norm: √(Σ aᵢⱼ²) over all elements — a vector's length; for a matrix the Frobenius (entrywise 2-)norm, not the spectral norm", "1 + n", "none", "O(n)", 18 },
	...
	{ "norm", "( m -- f )", "matrix.h2o: frobenius-norm under the short name (inlined)", "1 + n", "none", "O(n)", 18 },
